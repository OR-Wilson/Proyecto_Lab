...
\subsubsection{Contadores de tiempo y Display de cuenta regresiva}

Los tiempos de 20 s y 30 s se implementan con dos contadores síncronos 74LS192N en cascada (unidades y decenas) operando en modo descendente. La salida BCD de estos contadores se decodifica mediante dos integrados 4511BD (decodificador BCD a 7 segmentos con latch interno), uno para cada dígito. Cada segmento del display se protege con resistencias limitadoras de \SI{330}{\ohm}.

Esta configuración permite visualizar claramente la cuenta regresiva para el peatón.
\\
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.45\textwidth}{\centering \vspace{2.2cm} Espacio reservado para el esquemático del bloque de iluminación (LEDs vehiculares y peatonales) \vspace{2.2cm}}}
\caption{Esquema del subsistema de iluminación con LEDs y drivers.}
\label{fig:leds}
\end{figure}
